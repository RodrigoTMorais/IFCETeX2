...
% define se é para adicionar os anexos à impressão
\imprimirAnexos{sim}
...
\chefedepartamentopesquisa{Adolfo Átila Cabral Moreira}
...
\hline
 Projetos elétricos & 40 & 2\\
\hline
Domótica & 40 & 2\\
\hline 
Programação WEB & 40 & 2\\
\hline
...
\IFCEqua{}{
\begin{tabular}{|@{ }c@{ }|m{4cm}|@{ }c@{ }|@{ }c@{ }|c|c|c|c|}
\hline
\multicolumn{6}{|c|}{ Disciplinas do 1º Semestre} \\
\hline
\textbf{Código} & \textbf{DISCIPLINA} & \textbf{C.H. teórica} & \textbf{C.H. prática} & \textbf{Cred.} & \textbf{PR.} \\
\hline
01 & Eletricidade 1 & 80 & 40 & 4 & -\\
\hline
...
\hline
14 & Higiene e Segurança do Trabalho & 40 & 0 & 2 & -\\
\hline
...
\hline
6 & Desenho Assistido por Computador & 70 & 10 & 4 & -\\
\hline
8 & Metrologia & 20 & 20 & 2 & -\\
\hline
9 & Eletrônica Digital 2 & 30 & 10 & 2 & 03\\
\hline
7 & Cálculo Aplicado & 0 & 80 & 4 & 05\\
\hline
...
\textbf{Código} & \textbf{DISCIPLINA} & \textbf{C.H. teórica} & \textbf{C.H. prática} & Cred. & PR. \\
\hline
10 & Linguagem de Programação 1 & 60 & 20 & 4 & 4\\
\hline
...
\hline
33 & Redes de Computadores & 20 & 60 & 4,9\\
\hline
...
\hline
35 & Metodologia da Pesquisa Científica & 20 & 20 & 2 & -\\
\hline
...
\hline
42 & Controle da Produção & 20 & 20 & 2 & -\\
\hline
...
\hline
36 & Instrumentação Industrial & 20 & 20 & 2 & 19,27\\
\hline
...
%adição de fluxograma em PDF
\begin{landscape}
\addtocounter{chapter}{1}
\addcontentsline{toc}{chapter}{\arabic{chapter} \hspace{1.5 cm} FLUXOGRAMA DO CURSO}
%\chapter{Fluxograma do Curso}
\includepdf[landscape = true, pages=-]{fluxograma.pdf}
\end{landscape}
...
%, dentre outros gêneros acadêmicos que possam cumprir o objetivo de sistematização de conhecimentos obtidos ao longo do curso. A formatação dos trabalhos deverá estar de acordo com as orientações do Manual de Normalização de Trabalhos Acadêmicos do IFCE.\\
...
No quadro \ref{qua:doscentes-necessarios} é listada o corpo docente necessário ao funcionamento do curso, observe que esse quantitativo leva em conta não somente a carga horária quanto a disponibilidade para alocação de horários e demanda para orientação de trabalhos de extensão. Observe também, que esse estudo considera que os docentes estejam exclusivamente dedicados ao curso, de modo que em caso de compartilhamento de docentes entre outros cursos demandará mais profissionais.\\

\begin{quadro}[!h]	
\centering
\Caption{\label{qua:doscentes-necessarios} Docentes necessários}		
\IFCEqua{}{
\begin{tabular}{|p{5cm}|p{5cm}|c|}
\hline
\multicolumn{3}{|c|}{ Quadro Docente necessário} \\
\hline
\textbf{Área} & \textbf{sub-área} & \textbf{quantidade}\\
\hline
Engenharia elétrica e suas tecnologias & Transmissão e distribuição & 2 \\
\hline
Engenharia elétrica e suas tecnologias & eletrônica analógica e digital & 2 \\
\hline
Engenharia elétrica e suas tecnologias & eletrônica de potência & 1 \\
\hline
Engenharia elétrica e suas tecnologias & microprocessadores e e sistemas de controle & 2 \\
\hline
Engenharia elétrica e suas tecnologias & Redes industriais & 1 \\
\hline
Engenharia elétrica e suas tecnologias, engenharia mecânica e suas tecnologias & Computação Aplicada a engenharia & 1 \\
\hline
Engenharia elétrica e suas tecnologias, Informática & lógica e linguagem de programação & 1 \\
\hline
Engenharia mecânica suas tecnologias & Usinagem e métodos de fabricação & 1 \\
\hline
Engenharia mecânica suas tecnologias & mecanismos e atuadores mecânicos & 1 \\
\hline
Matemática e suas tecnologias & Cálculo  & 1 \\
\hline
Engenharia de produção & gerenciamento de produção & 1 \\
\hline
Física & Eletricidade e magnetismo, mecânica clássica & 1 \\
\hline
\end{tabular}
}{
\Fonte{Elaborado pelo autor}
...
Docentes de disciplinas como Libras, projetos sociais, inglês, metodologia científica e espanhol, podem ser compartilhado com outros cursos devido a baixa carga horária individual.\\

A quadro \ref{qua:docentes}, contem a lista de docentes atualmente compõem o quadro de professores do curso, note que não estão inclusos os docentes compartilhados de outros núcleos, pois estem podem variar a cada semestre.

\begin{quadro}[!h]	
\centering
\Caption{\label{qua:docentes} Quadro docente atual (2024)}		
\IFCEqua{}{
\begin{tabular}{|p{4cm}|p{2cm}|p{2cm}|p{3cm}|}
\hline
\multicolumn{4}{|c|}{ Quadro Docente atual} \\
\hline
\textbf{Nome} & \textbf{Qualificação} & \textbf{Titulação} & \textbf{Disciplinas}\\
\hline
Francisco Mozali Moreira & Engenheiro eletricista & Especialista & eletricidade 1 e 2 \\
\hline
Régia Talina Silva Araújo & Engenheira eletricista & Doutorado & Eletronica Digital 1, redes de computadores, TCC \\
\hline   
Andrea Virgínia Monteiro Fernandes Silva & Computação & Mestrado & lógica de programação, Linguagem de programação 1 \\
\hline   
Rodrigo Tavares de Morais & Tecnólogo em eletromecânica & Mestrado & Desenho assistido por computador, Engenharia assistida por computador \\
\hline   
Jucélio Alves Vidal & Engenheiro Mecânico & Especialista & Metrologia \\
\hline   
Derig Almeida Vidal & Técnólogo em automação & Mestrado & Instrumentação eletrônica, eletrônica digital 2, Linguagem de programação 2 \\
\hline   
Flávio Cesar de Brito Nunes & Engenheiro Eletricista & Doutorado & Eletrônica geral, Projetos em eletrônica, Instrumentação Industrial \\
\hline   
Rômulo Diniz Araújo & Tecnólogo em Eletromecânica & Mestrado & Comandos elétricos \\
\hline   
Ágio Gonçalves de Moraes Felipe & Engenheiro Eletricista & Mestrado & Microprocessadores 1 e 2, Controlador lógico Programável \\
\hline
Fábio Lavor Bezerra & Engenheiro em eletrônica & Especialista & Eletrônica de Potência \\
\hline   
Alexandre Magno Ferreira Diniz  & Engenheiro Eletricista & Doutorado & Máquinas elétricas \\
\hline   
Manuel Edervaldo Souto Araújo  & Engenheiro Eletricista & Mestrado & Controle de processos 1 e 2, Redes industriais \\
\hline   
Adolfo Átila Cabral Moreira   & Engenheiro Mecânico & Mestrado & Elementos de máquinas, Processos de fabricação \\
\hline   
Cicero de Alencar Leite & Engenheiro mecânico & Mestrado & Processos de fabricação, Acionamentos hidráulicos e pneumáticos \\
\hline   
...
A Biblioteca Carmem Helena Machado Guerreiro Sales, ocupa uma área de 955,11 m2, dividida em ambientes para estudo e pesquisa (destinado aos leitores) e para as atividades técnico-administrativas dos servidores.\\
...
O atendimento à comunidade interna (discentes, docentes e técnicos administrativos) e comunidade externa (público em geral), ocorre tanto presencialmente, quanto pelo e-mail:biblioteca.juazeiro@ifce.edu.br\\
...
\subsection{Salas para Coordenação de curso}
...
\subsection{Espaço para atendimento aos alunos}
...
\subsection{Recursos de tecnologia da informação e comunicação.}
...
\subsection{Laboratório de Matemática}
...
\subsection{Laboratório de hidráulica e pneumática}
...
\subsection{Laboratório de mecânica}
...
\begin{itemize}
\item 3 Alicates amperímetros;
\item 1 Analisador de energia;
\item 2 Bancadas para ensaios de eletrônica de potência;
\item 1 carga capacitiva;
\item 1 carga indutiva;
\item 1 carga resistiva;
\item 1 Conjunto didático para estudo de inversor de frequência com freio eletrodinâmico;
\item 7 Decibelímetros digitais;
\item 1 Sistema para ensaios de transformador monofásico;
\item 4 Kits didáticos para chaves de partidas com simulador de defeito;
\item 1 kit controlador lógico programável;
\item 2 kits didáticos de medidas elétricas;
\item 5 kits de motores;
\item 7 Luxímetros digitais;
\item 1 Osciloscópio digital;
\item 1 Projetor multimídia;
\item 1 Varivolt;
\item Componentes diversos para ensaios.
\end{itemize}

\subsection{Laboratório de criação e prototipagem}
Atende a disciplina de produção assistida por computador, e demais disciplinas sob demanda. Conta com os seguintes equipamentos:

\begin{itemize}
\item 2 Impressoras 3D FDM;
\item 1 Router CNC 200x200 mm;
\item 1 Televisor 55 polegadas;
\item 1 Computador com teclado e mouse;
\item 10 kits de ferramentas;
\item 10 parafusadeiras a bateria;
\item 15 kits didáticos com arduino e componentes;
\item Componentes diversos para montagens mecatrônicas;
\item Insumos para criação de componentes;
\end{itemize}

\chapter{Plano de migração de grade}
...
%Para os alunos que se matricularam no curso a partir de 19 de dezembro de 2022, haverá um período de transição, no qual ficarão obrigados a cumprir com a carga horária de extensão para conclusão do curso.(Art. 47 da Lei n.º 9394/96).
...
\begin{quadro}[!h]	
\centering
\Caption{\label{qua:equivalencia} Quadro de equivalência}		
\IFCEqua{}{
\begin{tabular}{| m{5cm} | m{5cm}|}
\hline
\multicolumn{2}{|c|}{Quadro de equivalência} \\
\hline
\textbf{AUT12} & \textbf{AUT24}\\
\hline
Eletricidade 1 \& Laboratório de eletricidade 1 & Eletricidade 1 \\
\hline
Eletronica digital 1 & Eletronica digital 1\\
\hline
Ciência da computação & Fundamentos da programação \\
\hline
Matemática aplicada & Matemática aplicada\\
\hline
Metodologia cintífica & Metodologia da pesquisa científica \\ 
\hline
Metrologia & Metrologia\\
\hline
Eletronica Digital 2 & Eletrônica digital 2\\
\hline
Linguagem de programação 1 & Linguagem de programação 1\\
\hline
instrumentação eletrônica & Instrumentação eletrônica\\
\hline
...
\hline
Desenho Assistido por Computador & Desenho Assistido por Computador \\
\hline
Cálculo Aplicado & Cálculo Aplicado \\
\hline
Eletricidade 2 & Eletricidade 2\\
\hline
Física 1 & Física 1\\
\hline
...
\clearpage
\null\vspace{10 cm}
\centering \huge \textbf{Programas de Unidades Didáticas (PUDs)}
\addcontentsline{toc}{chapter}{\hspace{2 cm} \uppercase{Programas de Unidades Didáticas }(PUDs)}
\pagebreak
%imprime PUDS ****************************************************
%1 semestre
\includepdf[pages=-]{PUDs/Eletricidade1.pdf}
\includepdf[pages=-]{PUDs/eletronica_Digital_1.pdf}
\includepdf[pages=-]{PUDs/fundamentos_da_programacao.pdf}
\includepdf[pages=-]{PUDs/matematica_aplicada.pdf}
\includepdf[pages=-]{PUDs/metodologia_da_pesquisa_científica.pdf}
%2 semestre
\includepdf[pages=-]{PUDs/metrologia.pdf}
\includepdf[pages=-]{PUDs/eletronica_Digital_2.pdf}
\includepdf[pages=-]{PUDs/linguagem_de_programacao1.pdf}
\includepdf[pages=-]{PUDs/Instrumentacao_eletronica.pdf}
\includepdf[pages=-]{PUDs/higiene_e_seguranca_do_Trabalho.pdf}
\includepdf[pages=-]{PUDs/estatistica.pdf}
\includepdf[pages=-]{PUDs/redes_de_computadores.pdf}
\includepdf[pages=-]{PUDs/projetos_sociais.pdf}
%3 semestre
\includepdf[pages=-]{PUDs/desenho_assistido_por_computador.pdf}
\includepdf[pages=-]{PUDs/calculo_aplicado.pdf}
\includepdf[pages=-]{PUDs/eletricidade2.pdf}
\includepdf[pages=-]{PUDs/fisica1.pdf}
\includepdf[pages=-]{PUDs/eletronica_geral.pdf}
%4 semestre
\includepdf[pages=-]{PUDs/microprocessadores1.pdf}
\includepdf[pages=-]{PUDs/projetos_em_eletronica.pdf}
\includepdf[pages=-]{PUDs/eletronica_de_potencia.pdf}
\includepdf[pages=-]{PUDs/linguagem_de_programação2.pdf}
\includepdf[pages=-]{PUDs/fisica2.pdf}
%5 semestre
\includepdf[pages=-]{PUDs/máquinas_eletricas.pdf}
\includepdf[pages=-]{PUDs/comandos_eletricos.pdf}
\includepdf[pages=-]{PUDs/elementos_de_maquinas.pdf}
\includepdf[pages=-]{PUDs/controle_de_processos1.pdf}
\includepdf[pages=-]{PUDs/acionamento_pneumatico.pdf}
\includepdf[pages=-]{PUDs/gestao_impresarial.pdf}
%6 Semestre
\includepdf[pages=-]{PUDs/microprocessadores2.pdf}
\includepdf[pages=-]{PUDs/processos_de_fabricacao.pdf}
\includepdf[pages=-]{PUDs/acionamentos_de_maquinas.pdf}
\includepdf[pages=-]{PUDs/acionamento_hidraulico.pdf}
\includepdf[pages=-]{PUDs/instrumentacao_industrial.pdf}
%7 Semestre
\includepdf[pages=-]{PUDs/controle_de_processos2.pdf}
\includepdf[pages=-]{PUDs/redes_industriais.pdf}
\includepdf[pages=-]{PUDs/controlador_logico_programavel.pdf}
\includepdf[pages=-]{PUDs/engenharia_assistida_por_computador.pdf}
\includepdf[pages=-]{PUDs/trabalho_de_conclusao_de_curso.pdf}
\includepdf[pages=-]{PUDs/controle_da_producao.pdf}
%disciplinas opcionais
\includepdf[pages=-]{PUDs/libras.pdf}
\includepdf[pages=-]{PUDs/ingles_instrumental.pdf}
\includepdf[pages=-]{PUDs/espanhol_instrumental.pdf}
\includepdf[pages=-]{PUDs/robotica_industrial.pdf}
\includepdf[pages=-]{PUDs/algebra_linear.pdf}
\includepdf[pages=-]{PUDs/fundamentos_de_energias_renovaveis.pdf}
\includepdf[pages=-]{PUDs/projetos_eletricos.pdf}
\includepdf[pages=-]{PUDs/domotica.pdf}
\includepdf[pages=-]{PUDs/programação_web.pdf}
...
%bibliografia sem citação
\nocite{fiec-sondagem}
\nocite{guia-do-estudante}
\nocite{ifce-rod}
\nocite{rais}
\nocite{sagan-mundo-assombrado}
\nocite{viana-industrializacao}
...
\ifthenelse{\boolean{ifcetex2@imprimirAnexos}}{
%adiciona apendices


%\includepdf[pages=-]{PUDs/.pdf}
\clearpage
\null\vspace{10 cm}
\centering \huge \textbf{Apendices}
\addcontentsline{toc}{chapter}{APENDICES}

\pagebreak

\includepdf[pages=-]{apendices.pdf}
}
