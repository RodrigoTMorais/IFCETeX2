...
\node (maqe) [disc4, below of= fis2] {\tiny Máquinas elétricas \\ 80h};

% 5 semestre %%%%%%%%%%%%%
\node (com) [disc5, right of=opt, xshift=2cm] {\tiny Comandos elétricos \\ 80h};
\node (prog2) [disc5, below of= com] {\tiny Linguagem de programação 2 \\ 80h};
\node (elem) [disc5, below of= prog2] {\tiny Elementos de máquinas \\ 40h};
