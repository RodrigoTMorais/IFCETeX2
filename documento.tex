...
\proreitorensino{nome do proreitor de ensino}
\proreitorpesquisa{nome do proreitor de pesquisa}
\proreitorextensao{nome do proreitor de extensão}
\proreitorgestaopessoas{nome do proreitor de pessoas}
\proreitoradministracao{nome do proreitor de administracao}
\diretorcampus{nome diretor do campus}
\diretorensino{nome coordenador de ensino}
\coordenadorpedagogico{nome do coordenador pedagógico}
\chefedepartamentopesquisa{chefe do departamento de pesquisa}
\chefedepartamentoextensao{chefe do departamento de extensão}
\coordenadorbiblioteca{coordenador da biblioteca}
\coordenadordecurso{coordenador do curso}
\nucleodocenteestruturante{nome - presidente\\ membro \\ membro }
\colegiado{nome - presidente \\ membro \\ membro}
