...
\textbf{Código} & \textbf{DISCIPLINA} & \textbf{C.H. teórica} & \textbf{C.H. prática} & Cred. & PR. \\
\hline
07 & Cálculo Aplicado & 100 & 0 & 5 & 01\\
\hline
08 & Metrologia & 30 & 30 & 3 & -\\
\hline
09 & Eletrônica Digital 2 & 48 & 12 & 3 & 03\\
\hline
10 & Linguagem de Programação 1 & 20 & 40 & 3 & 04\\
\hline
11 & Eletricidade 2 & 60 & 20 & 4 & 05,01\\
\hline
 12& Instrumentação Eletrônica & 26 & 14 & 2 & 03,01\\
\hline
...
\textbf{Código} & \textbf{DISCIPLINA} & \textbf{C.H. teórica} & \textbf{C.H. prática} & Cred. & PR. \\
\hline
13 & Física 1 & 60 & 20 &  & 05\\
\hline
14 & Higiene e Segurança do Trabalho & 20 & 20 &  & -\\
\hline
15 & Estatística & 40 & 0 &  & -\\
\hline
16 & Eletrônica Geral & 40 & 40 &  & 12,02\\
\hline
17 & Eletrotécnica & 30 & 30 &  & 11\\
\hline
18 & Microprocessadores 1 & 50 & 50 &  & 09,04\\
\hline
...
\textbf{Código} & \textbf{DISCIPLINA} & \textbf{C.H. teórica} & \textbf{C.H. prática} & Cred. & PR. \\
\hline
19 & Projetos em Eletrônica & 40 & 40 & 4 & 16,11\\
\hline
20 & Eletrônica Industrial & 60 & 20 & 4 & -16,11\\
\hline
21 & Comandos Elétricos & 30 & 30 & 3 & -17\\
\hline
22 & Linguagem de Programação 2 & 30 & 30 & 3 & -10\\
\hline
23 & Tecnologia Mecânica 1 & 30 & 30 & 3 & -08\\
\hline
24 & Física 2 & 40 & 20 & 3 & -13\\
\hline
...
\textbf{Código} & \textbf{DISCIPLINA} & \textbf{C.H. teórica} & \textbf{C.H. prática} & Cred. & PR. \\
\hline
25 & Máquinas Elétricas & 60 & 20 & 4 & 20,17\\
\hline
26 & Controle de Processos 1 & 60 & 0 & 3 & 07\\
\hline
27 & Microprocessadores 2 & 30 & 30 & 3 & 18\\
\hline
28 & Acionamento Pneumático e Eletro-pneumático & 40 & 40 & 4 & 21\\
\hline
29 & Tecnologia Mecânica 2 & 40 & 40 & 4 & 23\\
\hline
30 & Laboratório de Tecnologia Mecânica 2 & 20 & 20 & 2 & 23\\
\hline
...
\textbf{Código} & \textbf{DISCIPLINA} & \textbf{C.H. teórica} & \textbf{C.H. prática} & Cred. & PR. \\
\hline
31 & Acionamentos de Máquinas & 60 & 20 & 4 & 25,19-\\
\hline
32 & Controle de Processos 2 & 40 & 20 & 3 & 26\\
\hline
33 & Rede de Computadores & 30 & 30 & 3 & -\\
\hline
34 & Acionamentos hidráulicos e Eletro-hidraulicos & 40 & 40 & 4 & 28\\
\hline
...
\multicolumn{2}{|l|}{ \textbf{Subtotal}} & \multicolumn{2}{|c|}{\textbf{360}} &  \textbf{18} &  \\
\hline
\end{tabular}
}{
\Fonte{Elaborado pelo autor}
...
\textbf{Código} & \textbf{DISCIPLINA} & \textbf{C.H. teórica} & \textbf{C.H. prática} & Cred. & PR. \\
\hline
37 & Redes Industriais & 40 & 40 & 4 & 36,32\\
\hline
38 & Controlador Lógico Programável & 0 & 60 & 3 & 32,21\\
\hline
39 & Engenharia Assistida por Computador & 20 & 60 & 4 & 30,29\\
\hline
40 & Gestão Empresarial & 40 & 0 & 3 & 35\\
\hline
41 & Trabalho de Conclusão de Curso & 40 & 0 & 2 & 35\\
\hline
42 & Controle da Produção & 30 & 10 & 2 & 15\\
\hline
43 & Projetos Sociais & 40 & 0 & 2 & -\\
\hline
...
\multicolumn{2}{|l|}{ \textbf{Subtotal}} & \multicolumn{2}{|c|}{\textbf{240}} &  \textbf{12} &  \\
\hline
\end{tabular}
}{
\Fonte{Elaborado pelo autor}
...
\tikzstyle{disc1} = [rectangle, rounded corners, minimum width=2.5cm, minimum height=1cm,text centered, text width = 3cm, draw=black, fill=green!10]

\tikzstyle{disc2} = [rectangle, rounded corners, minimum width=2.5cm, minimum height=1cm,text centered, text width = 3cm, draw=black, fill=green!20]

\tikzstyle{disc3} = [rectangle, rounded corners, minimum width=2.5cm, minimum height=1cm,text centered, text width = 3cm, draw=black, fill=green!30]

\tikzstyle{disc4} = [rectangle, rounded corners, minimum width=2.5cm, minimum height=1cm,text centered, text width = 3cm, draw=black, fill=green!40]

\tikzstyle{disc5} = [rectangle, rounded corners, minimum width=2.5cm, minimum height=1cm,text centered, text width = 3cm, draw=black, fill=green!50]

\tikzstyle{disc6} = [rectangle, rounded corners, minimum width=2.5cm, minimum height=1cm,text centered, text width = 3cm, draw=black, fill=green!60]

\tikzstyle{disc7} = [rectangle, rounded corners, minimum width=2.5cm, minimum height=1cm,text centered, text width = 3cm, draw=black, fill=green!70]
...
\node (ele1) [disc1] {\tiny Eletricidade 1 \\ 120h};
\node (dig1) [disc1, below of=ele1] {\tiny Eletrônica Digital 1 \\ 80h};
\node (fundprog) [disc1, below of=dig1] {\tiny Fundamentos da programação \\ 80h};
\node (matap) [disc1, below of=fundprog] {\tiny Matemática aplicada \\ 80h};
\node (met) [disc1, below of=matap] {\tiny Metodologia da pesquisa Científica \\ 40h};

% 2 semestre %%%%%%%%%%%%%
\node (inst) [disc2, right of=ele1, xshift=2cm] {\tiny Instrumentação eletrônica \\ 40h};
\node (dig2) [disc2, below of= inst] {\tiny Eletronica Digital 2 \\ 40h};
\node (prog1) [disc2, below of= dig2] {\tiny Linguagem de programação 1 \\ 80h};
\node (metr) [disc2, below of= prog1] {\tiny Metrologia \\ 80h};
\node (hst) [disc2, below of= metr] {\tiny Higiene e segurança no trabalho \\ 40h};
\node (est) [disc2, below of= hst] {\tiny Estatística \\ 40h};
\node (red) [disc2, below of= est] {\tiny Redes de computadores \\ 40h};
\node (pros) [disc2, below of= red] {\tiny Projetos sociais \\ 40h};

% 3 semestre %%%%%%%%%%%%%
\node (ele2) [disc3, right of=inst, xshift=2cm] {\tiny Eletricidade 2 \\ 80h};
\node (calc) [disc3, below of= ele2] {\tiny Cálculo aplicado \\ 80h};
\node (cad) [disc3, below of = calc] {\tiny Desenho assistido por computador \\ 80h};
\node (fis1) [disc3, below of= cad] {\tiny Física 1 \\ 80h};
\node (eleg) [disc3, below of= fis1] {\tiny Eletronica Geral \\ 80h};

% 4 semestre %%%%%%%%%%%%%
\node (opt) [disc4, right of=ele2, xshift=2cm] {\tiny Disciplina Optativa \\ 40h};
\node (micro1) [disc4, below of= opt] {\tiny Microprocrssadores 1 \\ 80h};
\node (proe) [disc4, below of= micro1] {\tiny Projetos em eletrônica \\ 80h};
\node (elind) [disc4, below of= proe] {\tiny Eletroônica Industrial \\ 80h};
\node (fis2) [disc4, below of= elind] {\tiny Física 2 \\ 40h};
\node (prog2) [disc4, below of= fis2] {\tiny Linguagem de programação 2 \\ 80h};

% 5 semestre %%%%%%%%%%%%%
\node (com) [disc5, right of=opt, xshift=2cm] {\tiny Comandos elétricos \\ 80h};
\node (maqe) [disc5, below of= com] {\tiny Máquinas elétricas \\ 80h};
\node (elem) [disc5, below of= maqe] {\tiny Elementos de máquinas \\ 40h};
\node (cont1) [disc5, below of= elem] {\tiny Controle de processos 1 \\ 80h};
\node (ac1) [disc5, below of= cont1] {\tiny Acionamento Pnemáticos e eletropneumáticos \\ 80h};
\node (gest) [disc5, below of= ac1] {\tiny Gestão Empresarial \\ 40h};

% 6 semestre %%%%%%%%%%%%%
\node (micro2) [disc6, right of=com, xshift=2cm] {\tiny Microprocessadores 2 \\ 80h};
\node (prof) [disc6, below of= micro2] {\tiny Processos de fabricação \\ 80h};
\node (acm) [disc6, below of= prof] {\tiny Acionamento de máquinas \\ 80h};
\node (ac2) [disc6, below of= acm] {\tiny Acionamento hidraulicos e eletro hidraulicos \\ 80h};
\node (Insti) [disc6, below of= ac2] {\tiny Instrumentação Industrial \\ 40h};

% 7 semestre %%%%%%%%%%%%%
\node (contp2) [disc7, right of=micro2, xshift=2cm] {\tiny Controle de processos 2 \\ 80h};
\node (redi) [disc7, below of= contp2] {\tiny Redes Industriais \\ 80h};
\node (clp) [disc7, below of= redi] {\tiny Controladores lógicos programáveis \\ 80h};
\node (cae) [disc7, below of= clp] {\tiny Engenharia assistida por computador \\ 80h};
\node (tcc) [disc7, below of= cae] {\tiny Trabalho de conclusão de curso \\ 40h};
\node (conpro) [disc7, below of= tcc] {\tiny Controle da produção \\ 40h};
...
\draw [arrow] (ele1) |- node[pos=0]{} ++(0,0.8) -| (ele2);
\draw [arrow] (matap) |- node[pos=0]{} ++(0,0.8) -| (fis1);
\draw [arrow] (ele1) |- node[pos=0]{} ++(0,0.8) -| node[pos=0]{} ++(5.5,0) |- (eleg);
